...
public abstract class BaseParser {
     ...
     * @return Source
     * @throws ShapeError when parsing error occurs
     */
    public Source parse(String filename, TokenStream input) throws ShapeError {
        code = input;
    ...
    protected abstract void expect() throws ShapeError;
    protected abstract void expectationMatched() throws ShapeError;
}
