...
public class ShapeLogicalExprImpl extends ASTWrapperPsiElement implements ShapeLogicalExpr {

  public ShapeLogicalExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof ShapeVisitor) ((ShapeVisitor)visitor).visitLogicalExpr(this);
