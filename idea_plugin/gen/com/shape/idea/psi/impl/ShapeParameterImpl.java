...
public class ShapeParameterImpl extends ASTWrapperPsiElement implements ShapeParameter {

  public ShapeParameterImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof ShapeVisitor) ((ShapeVisitor)visitor).visitParameter(this);
