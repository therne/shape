...
public class ShapeTypeCastingExprImpl extends ASTWrapperPsiElement implements ShapeTypeCastingExpr {

  public ShapeTypeCastingExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof ShapeVisitor) ((ShapeVisitor)visitor).visitTypeCastingExpr(this);
