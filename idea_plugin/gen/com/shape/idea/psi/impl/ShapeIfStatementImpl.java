...
public class ShapeIfStatementImpl extends ASTWrapperPsiElement implements ShapeIfStatement {

  public ShapeIfStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof ShapeVisitor) ((ShapeVisitor)visitor).visitIfStatement(this);
