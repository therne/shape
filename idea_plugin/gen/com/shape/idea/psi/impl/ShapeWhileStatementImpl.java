...
public class ShapeWhileStatementImpl extends ASTWrapperPsiElement implements ShapeWhileStatement {

  public ShapeWhileStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof ShapeVisitor) ((ShapeVisitor)visitor).visitWhileStatement(this);
