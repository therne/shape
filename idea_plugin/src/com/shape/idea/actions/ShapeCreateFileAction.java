...
package com.shape.idea.actions;
...
public class ShapeCreateFileAction extends CreateTypedResourceFileAction  {
    private String myLastRootComponentName;

    public ShapeCreateFileAction() {
    ...
    private static List<String> getAvailableTagNames(AndroidFacet facet) {
        List<String> xmlTagNames = AndroidLayoutUtil.getPossibleRoots(facet);
        List<String> shapeTagNames = new ArrayList<String>();
        for (String xmlTag : xmlTagNames) {
            shapeTagNames.add(AndroidDictionary.shapeClassName(xmlTag));
        }
        return shapeTagNames;
    }
    ...
    public class MyDialog extends DialogWrapper {
        ...
        protected MyDialog(@NotNull AndroidFacet facet, @Nullable InputValidator validator) {
            ...
            final List<String> tagNames = getAvailableTagNames(facet);
